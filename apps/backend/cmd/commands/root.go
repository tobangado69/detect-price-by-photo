...
import (
	...
	"github.com/detect-price-by-photo/backend/internal"
...
var RootCmd = &cobra.Command{
	Use:   "backend",
	Short: "Detect Price modular Go backend",
	Long:  `Detect Price modular Go backend focused on vertical slices and maintainability.`,
