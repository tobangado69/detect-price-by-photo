...
func DefaultConfig() Config {
	return Config{
		...
		OTel: OTelConfig{
			...
			ServiceName:          "detect-price-backend",
		...
		AI: AIConfig{
			...
			AllowedModels:    "openai/gpt-4o-mini,anthropic/claude-3-5-haiku",
			ModeRouting:      "fast:openai/gpt-4o-mini|accurate:anthropic/claude-3-5-haiku|knowledge:anthropic/claude-3-5-haiku",
		},
