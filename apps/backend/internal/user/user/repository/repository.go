...
func (r *UserRepository) CreateUser(ctx context.Context, user *models.User) error {
	...
	query := `
		INSERT INTO ` + models.UserTable + ` (
			id, display_name, email, username, avatar_url, role, metadata, created_at, updated_at, email_verified_at,
...
func (r *UserRepository) GetUserByID(ctx context.Context, id uuid.UUID) (*models.User, error) {
	query := `
		SELECT id, display_name, email, username, avatar_url, role, metadata, created_at, updated_at, email_verified_at,
        last_login_at, banned_at, ban_expires, ban_reason
...
func (r *UserRepository) UpdateUser(ctx context.Context, user *models.User) error {
	...
	query := `
		...
		SET display_name = $1, email = $2, username = $3, avatar_url = $4, role = $5, metadata = $6, updated_at = $7,
        email_verified_at = $8, last_login_at = $9, banned_at = $10, ban_expires = $11, ban_reason = $12
		WHERE id = $13
	`
...
func (r *UserRepository) GetUserByEmail(ctx context.Context, email string) (*models.User, error) {
	query := `
        SELECT id, display_name, email, username, avatar_url, role, metadata, created_at, updated_at,
